...
class GUI(QMainWindow):
    ...
    def __init__(self, app):
        ...
        self.logger.rawLog('Welcome to Bert the bard!')
        self.logger.rawLog('Current build 3.0')
        self.logger.rawLog('================ Log output ===============')
    ...
    @asyncSlot()
    async def runBert(self, token):
        #TODO move this to app
        if self.bert != None:
            del self.bert

        self.bert = Bert()
        self.bert.setToken(token)
        self.bert.setLoop(self.app.getLoop())
        self.bert.setLogger(self.logger)
        self.bert.loadMods()
